...
public class Club_Data {
    private static String [] clubeName ={
            "Arsenal",
            "Aston Villa",
    ...
    private static String [] clubeDeskripsi = {
    ...
    static ArrayList<Club> getListData(){
        ...
        for (int position = 0; position <clubeName.length; position++){
            Club club =new Club();
            club.setName(clubeName[position]);
            club.setDeskripsi(clubeDeskripsi[position]);
